...
let imgStyle = document.getElementById('tweet_avatar')

const radios = document.querySelectorAll('input[type=radio]')


let nos = [0,1,2,3,4,5,6,7,8]
nos.forEach((index) => {radios[index].addEventListener('click', ()=> imgStyle.setAttribute('src', `./assets/${radios[index].getAttribute('id')}.png`))})
